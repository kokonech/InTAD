...
This visualization strategy allows to investigate the impact of TADs and 
focus on connections specific for the target cell type.
...
of modular chromatin architecture in humans. Cell, 
